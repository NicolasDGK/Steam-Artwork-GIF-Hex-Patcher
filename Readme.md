...
5.  **Patch:** Run `SteamArtworkGHP.bat`. It will detect your files and apply the Hex patch.
6.  **Upload:** Use the browser console scripts below to upload the gifs to your Steam.
